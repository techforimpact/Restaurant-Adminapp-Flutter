...
class _ReportTableState extends State<ReportTable>
  ...
  String dropdownvalue = 'Select Restaurent';
  String dropdownvalue1 = 'All';
  late String valueChoose;
  var items = ['Select Restaurent', 'Select Restaurents'];
  ...
  getReportDetail() async {
    ...
    restQuery.docs.forEach((element1) async {
      ...
      double commission = 0;
      commission =
          (earning * (double.parse(element1.get('commission').toString()) / 100))
              .toPrecision(2);
  ...
  getRevenue() {
    for (var element in reportList) {
      setState(() {
        ...
        totalProfit =
            totalProfit! + double.parse(element['commission'].toString()).toPrecision(2);
      });
    }
    setState(() {
      loader = false;
                              ...
                              child: Row(
                                children: [
                                  Expanded(
                                    child: Center(
                                      child: Text(
                                        '\$'+double.parse(totalEarning.toString()).toPrecision(2).toString(),
                                  ...
                                  Expanded(
                                    child: Center(
                                      child: Text(
                                        '\$'+double.parse(totalProfit.toString()).toPrecision(2).toString(),
                                        style: const TextStyle(
                                            color: Colors.black54),
                                      ),
                                    ),
